class CreateOverHeroBastions < ActiveRecord::Migration
  def change
    create_table :over_hero_bastions do |t|
      ...
      t.string  :TankKills
      t.string  :SentryKills_MostinGame
      t.string  :ReconKills_MostinGame
      t.string  :TankKills_MostinGame
      t.string  :TankKills_Average
      t.string  :SentryKills_Average
      t.string  :ReconKills_Average
      # t.string  :ShotsFired
      # t.string  :ShotsHit
    ...
    add_index :over_hero_bastions, :over_tag_id
  end
end
